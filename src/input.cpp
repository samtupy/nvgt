...
void RegisterInput(asIScriptEngine* engine) {
	...
	engine->RegisterGlobalFunction(_O("bool key_released(key_code key)"), asFUNCTION(KeyReleased), asCALL_CDECL);
	engine->RegisterGlobalFunction(_O("bool key_up(key_code key)"), asFUNCTION(key_up), asCALL_CDECL);
	engine->RegisterGlobalFunction(_O("bool insure_key_up(key_code key)"), asFUNCTION(insure_key_up), asCALL_CDECL);
	engine->RegisterGlobalFunction(_O("bool simulate_key_down(key_code key)"), asFUNCTION(simulate_key_down), asCALL_CDECL);
	engine->RegisterGlobalFunction(_O("bool simulate_key_up(key_code key)"), asFUNCTION(simulate_key_up), asCALL_CDECL);
