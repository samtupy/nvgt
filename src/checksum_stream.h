/* checksum_stream.h - Checksum wrapping istream implementation header
 *
...
#pragma once
/**
 * A simple istream/ ostream pair that passes data through a checksum before writing or returning it.
