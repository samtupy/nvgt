...
// These are needed by the various string constructors.
...
static const string StringCharAtStr(unsigned int i, const string &str)
{
	if( i >= str.size() )
	{
		// Set a script exception
...
static void StringSetCharAtStr(unsigned int i, const string& character, string &str)
{
	if( i >= str.size() )
	{
		// Set a script exception
