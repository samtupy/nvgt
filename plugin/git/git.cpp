...
void RegisterGit(asIScriptEngine* engine) {
	...
	engine->RegisterObjectMethod("git_repository", "int add(const string&in)", asMETHOD(nvgt_git_repository, add), asCALL_THISCALL);
	engine->RegisterObjectMethod("git_repository", "int add_all(string[]@, int=0)", asMETHOD(nvgt_git_repository, add_all), asCALL_THISCALL);
	engine->RegisterObjectMethod("git_repository", "int add_all(string[]@, int, git_repository_match_callback@, const string&in=\"\")", asMETHOD(nvgt_git_repository, add_all_cb), asCALL_THISCALL);
	engine->RegisterObjectMethod("git_repository", "int update_all(string[]@)", asMETHOD(nvgt_git_repository, update_all), asCALL_THISCALL);
	engine->RegisterObjectMethod("git_repository", "int update_all(string[]@, git_repository_match_callback@, const string&in=\"\")", asMETHOD(nvgt_git_repository, update_all_cb), asCALL_THISCALL);
	engine->RegisterObjectMethod("git_repository", "int remove(const string&in)", asMETHOD(nvgt_git_repository, remove), asCALL_THISCALL);
	engine->RegisterObjectMethod("git_repository", "int remove_all(string[]@)", asMETHOD(nvgt_git_repository, remove_all), asCALL_THISCALL);
	engine->RegisterObjectMethod("git_repository", "int remove_all(string[]@, git_repository_match_callback@, const string&in=\"\")", asMETHOD(nvgt_git_repository, remove_all_cb), asCALL_THISCALL);
	...
	engine->RegisterObjectMethod("git_repository", "git_repository_commit@ commit_lookup(const string&in)", asMETHOD(nvgt_git_repository, commit_lookup), asCALL_THISCALL);
	...
	engine->RegisterObjectMethod("git_repository", "git_repository_entry@ get_entry(uint)", asMETHOD(nvgt_git_repository, get_entry), asCALL_THISCALL);
