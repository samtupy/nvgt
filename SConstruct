...
if env["PLATFORM"] == "darwin":
	...
	env.Append(LIBS = [File("/usr/local/lib/libangelscript.a"), File("/usr/local/lib/libenet.a"), File("/opt/homebrew/lib/libcrypto.a"), File("/opt/homebrew/lib/libSDL3.a"), File("/opt/homebrew/lib/libssl.a"), "iconv"])
